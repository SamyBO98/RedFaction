...
public class GridAStar : MonoBehaviour
{
    ...
    Dictionary<int, int> walkableRegionsDico = new Dictionary<int, int>();
    ...
    private void Awake()
    {
        ...
        foreach(TerrainType region in walkableRegions)
        {
            ...
            walkableRegionsDico.Add((int)Mathf.Log(region.terrainMask.value,2),region.terrainPenalty);
        }
        CreateGrid();
    }
        ...
        for(int x =0; x< gridSizeX; x++)
        {
            for(int y=0; y < gridSizeY; y++)
            {
                ...
                if (walkable)
                {
                    ...
                    {
                        walkableRegionsDico.TryGetValue(hit.collider.gameObject.layer, out movementPenalty);
                    }
                }
